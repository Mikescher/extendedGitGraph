...
class ExtendedGitGraph {
	...
	const FILE_RAW_DATA      = 'git_graph_raw.dat';
	const FILE_FINISHED_DATA = 'git_graph_data.dat';
	...
	private $FILE_RAW_DATA      = 'git_graph_raw.dat';
	private $FILE_FINISHED_DATA = 'git_graph_data.dat';
